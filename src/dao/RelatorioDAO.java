...
public class RelatorioDAO {
    ...
    public List<Producao> listarProducaoPorData(String data) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                p.setDataProducao(("data_producao")); // usar String
    ...
    public List<Produtos> listarProdutosPorFuncionario(int idFuncionario) {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                prod.setNomeProdutos(rs.getString("nome_produto"));
